...
function CalenderNew() {
  return (
          <div class="flex items-center justify-center mb-4 w-full bg-slate-50">
              <div class="w-full shadow-lg">
                  <div class="md:p-8 p-5 dark:bg-gray-800 w-full bg-white rounded-xl">
                                      ...
                                      <td>
                                          <div class="w-full h-full">
                                              <div class="flex items-center justify-center w-full rounded-full cursor-pointer">
                                                  <a role="link" href="/" tabindex="0" class="focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:bg-indigo-500 hover:bg-indigo-500 text-base w-8 h-8 flex items-center justify-center font-medium text-white bg-indigo-700 rounded-full">8</a>
                                              </div>
                                          </div>
                                      </td>
                                      <td>
